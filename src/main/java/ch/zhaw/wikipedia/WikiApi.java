...
public class WikiApi {
  ...
  public static String get(String name, Integer sentences) {
    Long pageId = WikiApi.searchPageId(name);
    String extract = WikiApi.getPage(pageId, sentences);

    System.out.println("> DONE with " + name + ": " + extract);
    return extract;
  }
